...
def train_evaluate_and_plot_roc(df, target_column, feature_sets, parameter_grid, n_splits=7):
    ...
    for feature_columns in feature_sets:
        ...
        for train_index, test_index in kf.split(X_scaled):
            ...
            grid_search = GridSearchCV(SVC(probability=True), param_grid=parameter_grid, cv=5, scoring='roc_auc')
...
feature_sets = [
    ...
    ['Ab40'],['Ab42'],['Nfl'],['pT181P'],['Ab ratio']
    #[ 'AB142P/AB140P', 'AB140P', 'AB142P', 'NFL-BL','pT181P', 'sexo_1M_2F', 'años_educacion', 'edad']#, 'APOE risk']
]
